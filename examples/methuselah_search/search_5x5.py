...
class Search(object):
    ...
    def check_for_methuselah(self, s1_json, n_alive_cells):
        ...
        for istep in range(200):
            ...
            if (livecounts['liveCells1'] == self.n_alive_cells - 1) and (s1json in self.resultsm1):
            ...
            if istep < static_gens:
                ...
                if all_elements_equal(window):
                    ...
                    # if we reached steady state, ensure it takes at least G generations
                    G = 50
                    if istep < G:
                        return False
        ...
        if stop_early:
            ...
            # We made it through all iterations without stopping
